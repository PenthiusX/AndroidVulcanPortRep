...
void VulcanRenderer::render(){
    drawFrame();
}
void VulcanRenderer::clean(){
    cleanup();
}
...
void VulcanRenderer::initWindow(android_app* app){//Conversion of the windowing library
    androidAppCtx = app;
    if (!InitVulkan()) {
    ...
    //--------------------------------------------------------------
    //--------------------------------------------------------------
void VulcanRenderer::setupVulcan()
{
...
//        glfwTerminate();
    ...
    //--------------------------------------------------------------
    //--------------------------------------------------------------
void VulcanRenderer::createInstance() {
...
//        }
    ...
    //--------------------------------------------------------------
    //--------------------------------------------------------------
void VulcanRenderer::pickPhysicalDevice(){
...
void VulcanRenderer::createSwapChain() {
    ...
    //--------------------------------------------------------------
    //--------------------------------------------------------------
void VulcanRenderer::createImageViews() {
...
void VulcanRenderer::createCommandBuffers() {
    ...
    //--------------------------------------------------------------
    //--------------------------------------------------------------
void VulcanRenderer::createSyncObjects() {
...
//    }
    ...
    //--------------------------------------------------------------
    //--------------------------------------------------------------
VkSurfaceFormatKHR VulcanRenderer::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
//--------------------------------------------------------------
//--------------------------------------------------------------
VkPresentModeKHR VulcanRenderer::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
//--------------------------------------------------------------
//--------------------------------------------------------------
VkExtent2D VulcanRenderer::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
//--------------------------------------------------------------
//--------------------------------------------------------------
SwapChainSupportDetails VulcanRenderer::querySwapChainSupport(VkPhysicalDevice device) {
    ...
    //--------------------------------------------------------------
    //--------------------------------------------------------------
bool VulcanRenderer::isDeviceSuitable(VkPhysicalDevice device) {
...
bool VulcanRenderer::checkDeviceExtensionSupport(VkPhysicalDevice device) {
    ...
    //--------------------------------------------------------------
    //--------------------------------------------------------------
QueueFamilyIndices VulcanRenderer::findQueueFamilies(VkPhysicalDevice device) {
...
bool VulcanRenderer::checkValidationLayerSupport() {//Redundant on android
    uint32_t layerCount;
...
std::vector<char> VulcanRenderer::readFile(const std::string& filename) {
